                ...
                <main>
                    <?php
                        if(isset($_POST['submit'])) {
                            ...
                            $countname = $stmt2->rowCount();
                            if($countname != 0) {
                                $error_name_exist = " name already exist!";
                            };
                            ...
                            if($password != $confirm_password) {
                                ...
                                $sql = "INSERT INTO users (user_name, user_email, user_password, registered_on) VALUES (:name, :email, :password, :date)";
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5 mb-3">
                                    ...
                                    <div class="card-body">
                                        <form action="signup.php" method="POST">
                                            <?php 
                                                if(isset($error_name_exist)) {
                                                    echo "<p class='alert alert-danger'>{$error_name_exist}</p>";
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="username"> Name</label>
                                                <input name="name" class="form-control py-4" id="username" type="text" placeholder="Enter  name" required="true" />
                                            </div>
