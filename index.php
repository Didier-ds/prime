                        ...
                        <div id="inner-content" class="inner-content-wrap">
                            <div class="page-content">
                                ...
                                <div class="rev_slider_wrapper fullwidthbanner-container">
                                    <div id="rev-slider2" class="rev_slider fullwidthabanner">
                                        <ul>
                                            ...
                                            <li data-transition="random">
                                                <!-- Main Image -->
                                                <img src="assets/image/slides/slider2.jpg" alt="image" data-bgposition="center center" data-no-retina>
                                            ...
                                            <div class="col-12">
                                                <div class="box-intro-top">
                                                    ...
                                                    <div class="box-content-intro">
                                                        ...
                                                        <div class="title-heading wow fadeInUp true-health">
                                                            True Healthcare For<br> You and Your Family
                                                        </div>
                                                        ...
                                                        <div class="row-content-intro wow fadeInUp">
                                                            <div class="cl-content-intro cl-intro-1">
                                                                <div class="box-icon">
                                                            ...
                                                            <div class="cl-content-intro cl-intro-2">
                                                                <div class="box-icon">
                                ...
                                <section class="fl-row intro-middle">
                                    <div class="container">
                                        <div class="row">
                                            <div class="themesflat-spacer clearfix" data-desktop="150" data-mobile="20" data-smobile="20"></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="box-heading-intro">
                                                    ...
                                                    <div class="title-heading wow fadeInDown title-provide-health">
                                                        Providing Prime Health Care For Our Community
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="box-item wow fadeInUp" data-wow-delay="200ms">
                                                    <div class="img">
                                                        ...
                                                        <img src="assets/image/star.jpg" alt="image">
                                                    </div>
                                                    <div class="box-wrap">
                                                        <div class="title">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                  <div class="box-wrap-title  wow fadeInDown services-render ser-rend">
                                                        ...
                                                        <p class="text-color-white">We accommodate you by providing you with an attendant to fit your schedule.</p>
                                                  </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <div class="themesflat-spacer clearfix" data-desktop="0" data-mobile="0" data-smobile="40" ></div>
                                                    <div class="col-box">
                                                        <div class="box-icon">
                                                            ...
                                                            <img src="./assets/image/assistance.png" alt="personal assistant">
                                                        </div>
                                                        ...
                                                        <div class="box-wrap">
                                                            ...
                                                            <p>Our Personal Assistance Services are provided by tested and trained attendants who are competent in the care of children, young adults and the elderly with special needs/care.
                                                    ...
                                                    <div class="col-box">
                                                        <div class="box-icon active">
                                                            <!-- <i class="icon-Path-18154 font-size-big"></i> -->
                                                            <img src="./assets/image/social-care (1).png" alt="community">
                                                        </div>
                                                        <!-- <div class="themesflat-spacer clearfix" data-desktop="38" data-mobile="38" data-smobile="38"></div> -->
                                                        <div class="box-wrap">
                                                            <h2 class="box-change font-rubik">
                                                            ...
                                                            <p>Our Community Attendant Services are provided for adults and children whose health problems cause them to be functionally limited in performing activities of daily living.</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-box">
                                                        <div class="box-icon">
                                                            <!-- <i class="icon-Path-18174 font-size-big"></i> -->
                                                            <img src="./assets/image/eye.png" alt="supervision">
                                                        </div>
                                                        <!-- <div class="themesflat-spacer clearfix" data-desktop="38" data-mobile="38" data-smobile="38"></div> -->
                                                        <div class="box-wrap">
                                                            <h2 class="box-change font-rubik">
                                                            ...
                                                            <p>Protective Supervision is a supportive service for people who, due to a physical or mental disability need to be observed at times to protect them from injuries, hazards or accidents.</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-box bd-none">
                                                        <div class="box-icon icon-18158">
                                                            <!-- <i class="icon-Path-18158 font-size-big"></i> -->
                                                            <img src="./assets/image/healthcare.png" alt="Respite">
                                                        </div>
                                                        <!-- <div class="themesflat-spacer clearfix" data-desktop="38" data-mobile="38" data-smobile="38"></div> -->
                                                        <div class="box-wrap">
                                                            <h2  class="box-change font-rubik">
                                                            ...
                                                            <p>Respite care involves short term or temporary care of the sick or disabled for a few hours or weeks. It is designed to provide some relief to the regular caregiver.</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="col-counter fl-h1">
                                                    ...
                                                    <div class="box">
                                                        ...
                                                        <div class="themesflat-spacer clearfix" data-desktop="15" data-mobile="15" data-smobile="15"></div>
                                                        <div class="title-heading text-color-white">
                                                            <span class="number" data-from="0" data-to="23" data-speed="3000" data-inviewport="yes">23</span>+
                                                        </div>
                                                        <div class="themesflat-spacer clearfix" data-desktop="5" data-mobile="5" data-smobile="5"></div>
                                            ...
                                            <div class="col-12">
                                                <div class="row-counter">
                                                    <div class="box-counter-img">
                                                        ...
                                                        <img src="assets/image/Healthcare.jpg" alt="image">
                                                    </div>
                                                    <div class="box-counter-wrap">
                                                        <div class="themesflat-spacer clearfix" data-desktop="0" data-mobile="0" data-smobile="30"></div>
                                                        <div class="wrap-counter">
                                                            <div class="title-heading text-color-white">
                                                               Health Care:<br> A Basic Human Right
                                                            </div>
                                                            <p class="text-color-white">
                                                                We provide available, coordinated and comprehensive healthcare combined with other human services when appropriate.
                                                            </p>
                                                        </div>
                                                        <div class="themesflat-spacer clearfix" data-desktop="0" data-mobile="0" data-smobile="30"></div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="box-heading-process text-center">
                                                   ...
                                                   Our Clients and Community Matters
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-process">
                                                    <div class="box-process wow fadeInUp">
                                                        <div class="feature-process">
                                                            <div class="themesflat-spacer clearfix" data-desktop="40" data-mobile="0" data-smobile="0"></div>
                                                            <img src="assets/image/common/process01.jpg" alt="image" width="260px">
                                                        </div>
                                                ...
                                                <div class="col-process">
                                                    <div class="box-process wow fadeInUp"  data-wow-delay="100ms">
                                                        ...
                                                        <div class="box-wrap pdt-30">
                                                            ...
                                                            <p class="text-color-title-sidebar">
                                                                We care deeply for our community and dedicate significant time and resources to local events and charities for families with special needs.
                                                ...
                                                <div class="col-process" >
                                                    <div class="box-process wow fadeInUp" data-wow-delay="200ms">
                                                        <div class="feature-process">
                                                            ...
                                                            <img src="assets/image/common/process02.jpg" alt="image" width="270px">
                                                        </div>
                                                        <div class="box-wrap pdt-30">
                                                            <h2>
                                                                Thoughfulness
                                                            ...
                                                            <p class="text-color-title-sidebar">
                                                                We insist our caregivers represent our ideals of integrity, loyalty and empathy. We make all efforts to match their qualifications, interests and unique characteristics with your needs.
                                               ...
                                               <div class="fl-box-contact">
                                                    ...
                                                    <div class= "form-contact-us">
                                                        ...
                                                        <form class="content-form wow fadeInUp" method="post" id="contactform" action="./contact/contact-process.php" accept-charset="utf-8" novalidate="novalidate">
                                                            ...
                                                            <div>
                                                                <textarea class="form-control" id="exampleFormControlTextarea2" placeholder="Your Message"  maxlength="1000"></textarea>
                                                            </div>
