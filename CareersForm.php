        ...
        <div class="wrapper">
            ...
            <div id="contact_us_form_1" class="template_form">
				...
				<?php 	if (isset($_POST['submit'])) {
						 	...
						 	$sql = "INSERT INTO applicant (applicant_id, applicant_job_title, firstname, lastname, middlename, day_phone, even_phone, email, language, address, city, state, zipcode, registration_number) VALUES 
                                 (:applicant_id, :applicant_job_title, :firstname, :lastname, :middlename, :address, :city, :state, :zipcode, :day_phone, :even_phone, :email, :language, :registration_number)";
                        ...
                        $sql = "INSERT INTO confidentiality (applicant_id, investigation, process, termination, rules, valid) VALUES (:applicant_id, :investigation, :process, :termination, :rules, :valid)";
                               ...
                               $name1 = $_POST['___Name'];
                                ...
                                $sql = "INSERT INTO signature (applicant_id, signature) VALUES (:applicant_id, :signature)";
                                    $stmt = $pdo-> prepare($sql);
                                    $stmt-> execute([
                                        ':applicant_id' => $applicant_id,
                                        ':signature' => "$name1",
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box"><input type="text"
                                                name="Applicant_Job_Title" class="form_field" value=""
                                                id="Applicant_Job_Title" placeholder="Enter job title here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
<!-- 
                            <div class="form_box">
                                <div class="form_box_col3">
                                    <div class="group">
                                        ...
                                        <input id="Type_of_Employment_Desired" type="hidden"
                                            name="Type_of_Employment_Desired" value="">
                                        <table class="checkbox-table" border="0" cellpadding="0" cellspacing="0"
                                            style="margin-top:6px; width: 100%;">
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="wskCheckbox Type_of_Employment_Desired"
                                                        name="checkboxVal" value="Per Diem"
                                                        id="Type_of_Employment_Desired_1" /><label class="wskLabel"
                                                        for="Type_of_Employment_Desired_1">Per Diem</label></td>
                                            </tr>
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="wskCheckbox Type_of_Employment_Desired"
                                                        name="checkboxVal" value="Part Time"
                                                        id="Type_of_Employment_Desired_2" /><label class="wskLabel"
                                                        for="Type_of_Employment_Desired_2">Part Time</label></td>
                                            </tr>
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="wskCheckbox Type_of_Employment_Desired"
                                                        name="checkboxVal" value="Full Time"
                                                        id="Type_of_Employment_Desired_3" /><label class="wskLabel"
                                                        for="Type_of_Employment_Desired_3">Full Time</label></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="group">
                                        <div class="field_holder animated_box" id="toggle1">
                                            <input type="text" name="Per_Diem_Hours" class="form_field" value=""
                                                id="Per_Diem_Hours" placeholder="Enter number of hours here">
                                            <span class="animated_class"></span>
                                        </div>
                                        <div class="field_holder animated_box" id="toggle2">
                                            <input type="text" name="Part-Time_Hours" class="form_field" value=""
                                                id="Part-Time_Hours" placeholder="Enter number of hours here">
                                            <span class="animated_class"></span>
                                        </div>
                                        <div class="field_holder animated_box" id="toggle3">
                                            <input type="text" name="Full-Time_Hours" class="form_field" value=""
                                                id="Full-Time_Hours" placeholder="Enter number of hours here">
                                            <span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        <div class="field_holder animated_box" id="toggle4">
                                            <input type="text" name="Per_Diem_Days" class="form_field" value=""
                                                id="Per_Diem_Days" placeholder="Enter number of hours here">
                                            <span class="animated_class"></span>
                                        </div>
                                        <div class="field_holder animated_box" id="toggle5">
                                            <input type="text" name="Part-Time_Days" class="form_field" value=""
                                                id="Part-Time_Days" placeholder="Enter number of hours here">
                                            <span class="animated_class"></span>
                                        </div>
                                        <div class="field_holder animated_box" id="toggle6">
                                            <input type="text" name="Full-Time_Days" class="form_field" value=""
                                                id="Full-Time_Days" placeholder="Enter number of hours here">
                                            <span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                             ...
                             <div class="form_box">
                                <div class="form_box_col3">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Last Name <span
                                                        class="required_filed">*</span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Last_Name"
                                                class="form_field" value="" id="Last_Name"
                                                placeholder="Enter last name here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>First Name <span
                                                        class="required_filed">*</span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="First_Name"
                                                class="form_field" value="" id="First_Name"
                                                placeholder="Enter first name here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Middle Name <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Middle_Name"
                                                class="form_field" value="" id="Middle_Name"
                                                placeholder="Enter middle name here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box"><input type="text" name="Address"
                                                class="form_field" value="" id="Address"
                                                placeholder="Enter address here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col3">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>City <span
                                                        class="required_filed">*</span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="City"
                                                class="form_field" value="" id="City"
                                                placeholder="Enter city here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>State <span
                                                        class="required_filed">*</span></strong></label></div>
                                    ...
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>ZIP Code <span
                                                        class="required_filed">*</span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="ZIP_Code"
                                                class="form_field" value="" id="ZIP_Code"
                                                placeholder="Enter zip code here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                             ...
                             <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Day Phone <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Day_Phone" class="form_field cphone" id="Day_Phone"
                                                placeholder="+1 (phone number)"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Evening_Phone" class="form_field cphone" id="Evening_Phone"
                                                placeholder="+1 (phone number)"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Email Address
                                                    <span class="required_filed">*</span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Email_Address"
                                                class="form_field" value="" id="Email_Address"
                                                placeholder="Enter email here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box"><input type="text"
                                                name="Languages_Spoken_or_Written" class="form_field" value=""
                                                id="Languages_Spoken_or_Written"
                                                placeholder="Enter languages here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Please provide
                                                    Registration Number with Department of Social Services <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text"
                                                name="Registration_Number_with_Department_of_Social_Services"
                                                class="form_field" value=""
                                                id="Registration_Number_with_Department_of_Social_Services"
                                                placeholder="Enter details here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                         <div class="fieldheader">
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>High School Name
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text"
                                                name="High_School_Name" class="form_field" value=""
                                                id="High_School_Name" placeholder="Enter school name here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>State or Country
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text"
                                                name="State_or_Country" class="form_field" value=""
                                                id="State_or_Country" placeholder="Enter state or country here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box_col1">
                                <div class="group">
                                    <div class="form_label"><label class="text_uppercase"><strong>Graduate <span
                                                    class="required_filed"></span></strong></label></div>
                                    <table class="radio" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style='width: 50%;'><input type="radio" name="Graduate" value="Yes"
                                                    id="Graduate0"><label for="Graduate0"
                                                    style="font-weight:normal; color:#000;">Yes</label></td>
                                            <td style='width: 50%;'><input type="radio" name="Graduate" value="No"
                                                    id="Graduate1"><label for="Graduate1"
                                                    style="font-weight:normal; color:#000;">No</label></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>College Name <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="College_Name"
                                                class="form_field" value="" id="College_Name"
                                                placeholder="Enter college name here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>State or Country
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text"
                                                name="State_or_Country_" class="form_field" value=""
                                                id="State_or_Country_" placeholder="Enter state or country here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box_col1">
                                <div class="group">
                                    ...
                                    <table class="radio" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style='width: 50%;'><input type="radio" name="Graduate_" value="Yes"
                                                    id="Graduate_0"><label for="Graduate_0"
                                                    style="font-weight:normal; color:#000;">Yes</label></td>
                                            <td style='width: 50%;'><input type="radio" name="Graduate_" value="No"
                                                    id="Graduate_1"><label for="Graduate_1"
                                                    style="font-weight:normal; color:#000;">No</label></td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Type of Degree
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Type_of_Degree"
                                                class="form_field" value="" id="Type_of_Degree"
                                                placeholder="Enter degree here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box"><input type="text"
                                                name="Other_or_Licenses" class="form_field" value=""
                                                id="Other_or_Licenses" placeholder="Enter other here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Employer Name
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Employer_Name"
                                                class="form_field" value="" id="Employer_Name"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Location <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Location"
                                                class="form_field" value="" id="Location"
                                                placeholder="Enter location here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box1">
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="field_holder animated_box"><input type="text" name="From"
                                                class="form_field Date" value="" id="From"
                                                placeholder="Enter date here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="field_holder animated_box"><input type="text" name="To"
                                                class="form_field Date" value="" id="To"
                                                placeholder="Enter date here"><span class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Hours per Week
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Hours_per_Week"
                                                class="form_field" value="" id="Hours_per_Week"
                                                placeholder="Enter hours here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box"> <i id="icon"
                                                class="fas fa-dollar-sign "></i> <input type="text"
                                                name="Salary_or_Rate_per_hour" class="form_field amount" id="salary_or_rate_per_hour"
                                                 placeholder="Enter salary here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Job Title <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Job_Title"
                                                class="form_field" value="" id="Job_Title"
                                                placeholder="Enter title here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Supervisor <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Supervisor"
                                                class="form_field" value="" id="Supervisor"
                                                placeholder="Enter supervisor here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Number <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Number"
                                                class="form_field" value="" id="Number"
                                                placeholder="Enter number here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Describe Work
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><textarea name="Describe_Work"
                                                class="form_field" id="Describe_Work"
                                                placeholder="Enter details here"></textarea><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Reason for leaving
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><textarea name="Reason_for_leaving"
                                                class="form_field" id="Reason_for_leaving"
                                                placeholder="Enter reason here"></textarea><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Employer Name
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Employer_Name1"
                                                class="form_field" value="" id="Employer_Name1"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Location <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Location1"
                                                class="form_field" value="" id="Location1"
                                                placeholder="Enter location here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box1">
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="field_holder animated_box"><input type="text" name="From1"
                                                class="form_field Date" value="" id="From1"
                                                placeholder="Enter date here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="field_holder animated_box"><input type="text" name="To1"
                                                class="form_field Date" value="" id="To1"
                                                placeholder="Enter date here"><span class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Hours per Week
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Hours_per_Week1"
                                                class="form_field" value="" id="Hours_per_Week1"
                                                placeholder="Enter hours here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box"> <i id="icon"
                                                class="fas fa-dollar-sign "></i> <input type="text"
                                                name="Salary_or_Rate_per_hour1" class="form_field amount"
                                                id="salary_or_rate_per_hour1"
                                                placeholder="Enter salary here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Job Title <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Job_Title1"
                                                class="form_field" value="" id="Job_Title1"
                                                placeholder="Enter title here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Supervisor <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Supervisor1"
                                                class="form_field" value="" id="Supervisor1"
                                                placeholder="Enter supervisor here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Number <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Number1"
                                                class="form_field" value="" id="Number1"
                                                placeholder="Enter number here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Describe Work
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><textarea name="Describe_Work1"
                                                class="form_field" id="Describe_Work1"
                                                placeholder="Enter details here"></textarea><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Reason for leaving
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><textarea name="Reason_for_leaving1"
                                                class="form_field" id="Reason_for_leaving1"
                                                placeholder="Enter reason here"></textarea><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Employer Name
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Employer_Name2"
                                                class="form_field" value="" id="Employer_Name2"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Location <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Location2"
                                                class="form_field" value="" id="Location2"
                                                placeholder="Enter location here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box1">
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="field_holder animated_box"><input type="text" name="From2"
                                                class="form_field Date" value="" id="From2"
                                                placeholder="Enter date here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="field_holder animated_box"><input type="text" name="To2"
                                                class="form_field Date" value="" id="To2"
                                                placeholder="Enter date here"><span class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Hours per Week
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text"
                                                name="Hours_per_Week2" class="form_field" value=""
                                                id="Hours_per_Week2" placeholder="Enter hours here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Salary or Rate per
                                        ...
                                        <div class="field_holder animated_box"> <i id="icon"
                                                class="fas fa-dollar-sign "></i> <input type="text"
                                                name="Salary_or_Rate_per_hour2" class="form_field amount"
                                                id= "salary_or_rate_per_hour2"
                                                placeholder="Enter salary here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Job Title <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Job_Title2"
                                                class="form_field" value="" id="Job_Title2"
                                                placeholder="Enter title here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Supervisor <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Supervisor2"
                                                class="form_field" value="" id="Supervisor2"
                                                placeholder="Enter supervisor here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Number <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Number2"
                                                class="form_field" value="" id="Number2"
                                                placeholder="Enter number here"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Describe Work
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><textarea name="Describe_Work2"
                                                class="form_field" id="Describe_Work2"
                                                placeholder="Enter details here"></textarea><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Reason for leaving
                                                    <span class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><textarea name="Reason_for_leaving2"
                                                class="form_field" id="Reason_for_leaving2"
                                                placeholder="Enter reason here"></textarea><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        ...
                                        <table class="radio" border="0" cellpadding="0" cellspacing="0">
                                            <tr></tr>
                                            <tr>
                                                <td><input type="radio" name="Can_you_lift_at_least_65_lbs" value="Yes"
                                                        id="Can_you_lift_at_least_65_lbs?0"><label
                                                        for="Can_you_lift_at_least_65_lbs?0"
                                                        style="font-weight:normal; color:#000;">Yes</label></td>
                                                <td><input type="radio" name="Can_you_lift_at_least_65_lbs" value="No"
                                                        id="Can_you_lift_at_least_65_lbs?1"><label
                                                        for="Can_you_lift_at_least_65_lbs?1"
                                                        style="font-weight:normal; color:#000;">No</label></td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Do you have any
                                                    ...
                                                    to perform the essential functions of your job? <span
                                                        class="required_filed"></span></strong></label></div>
                                        <table class="radio" border="0" cellpadding="0" cellspacing="0">
                                            <tr></tr>
                                            <tr>
                                                <td><input type="radio"
                                                        name="mental_limitation"
                                                        value="Yes"
                                                        id="Do_you_have_any_physical_or_mental_limitation_that_may_interfere_with_your_ability_to_perform_the_essential_functions_of_your_job?0"><label
                                                        for="Do_you_have_any_physical_or_mental_limitation_that_may_interfere_with_your_ability_to_perform_the_essential_functions_of_your_job?0"
                                                        style="font-weight:normal; color:#000;">Yes</label></td>
                                                <td><input type="radio"
                                                        name="mental_limitation"
                                                        value="No"
                                                        id="Do_you_have_any_physical_or_mental_limitation_that_may_interfere_with_your_ability_to_perform_the_essential_functions_of_your_job?1"><label
                                                        for="Do_you_have_any_physical_or_mental_limitation_that_may_interfere_with_your_ability_to_perform_the_essential_functions_of_your_job?1"
                                                        style="font-weight:normal; color:#000;">No</label></td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Please describe
                                                    any accommodations that you require <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><textarea name="Accommodations"
                                                class="form_field" id="Accommodations"
                                                placeholder="Enter accommodations here"></textarea><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>  
                           ...
                           <div class="fieldheader">
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Have you ever been
                                                    convicted of a misdemeanor? <span
                                                        class="required_filed"></span></strong></label></div>
                                        ...
                                        <table class="radio" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td><input type="radio"
                                                        name="Have_you_ever_been_convicted_of_a_misdemeanor"
                                                        value="Yes"
                                                        id="Have_you_ever_been_convicted_of_a_misdemeanor?0"><label
                                                        for="Have_you_ever_been_convicted_of_a_misdemeanor?0"
                                                        style="font-weight:normal; color:#000;">Yes</label></td>
                                                <td><input type="radio"
                                                        name="Have_you_ever_been_convicted_of_a_misdemeanor" value="No"
                                                        id="Have_you_ever_been_convicted_of_a_misdemeanor?1"><label
                                                        for="Have_you_ever_been_convicted_of_a_misdemeanor?1"
                                                        style="font-weight:normal; color:#000;">No</label></td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        ...
                                        <table class="radio" border="0" cellpadding="0" cellspacing="0">
                                            <tr></tr>
                                            <tr>
                                                <td><input type="radio" name="Have_you_ever_been_convicted_of_a_felony"
                                                        value="Yes"
                                                        id="Have_you_ever_been_convicted_of_a_felony?0"><label
                                                        for="Have_you_ever_been_convicted_of_a_felony?0"
                                                        style="font-weight:normal; color:#000;">Yes</label></td>
                                                <td><input type="radio" name="Have_you_ever_been_convicted_of_a_felony"
                                                        value="No"
                                                        id="Have_you_ever_been_convicted_of_a_felony?1"><label
                                                        for="Have_you_ever_been_convicted_of_a_felony?1"
                                                        style="font-weight:normal; color:#000;">No</label></td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div class="form_box_col1">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Please describe.
                                                    ...
                                                    disqualification of your application. <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><textarea name="Explanation"
                                                class="form_field" id="Explanation"
                                                placeholder="Enter explanation here"></textarea><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="radio" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td><input type="radio"
                                                        name="fingerprint"
                                                        value="Yes"
                                                        id="fingerprint0"><label
                                                        for="fingerprint0"
                                                        style="font-weight:normal; color:#000;">Yes</label></td>
                                                <td><input type="radio"
                                                        name="fingerprint"
                                                        value="No"
                                                        id="fingerprint1"><label
                                                        for="fingerprint1"
                                                        style="font-weight:normal; color:#000;">No</label></td>
                                            </tr>
                                        </table>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Name <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Name"
                                                class="form_field" value="" id="Name"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Relationship <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Relationship"
                                                class="form_field" value="" id="Relationship"
                                                placeholder="Enter relationship here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Day_Phone_Number" class="form_field cphone" id="Day_Phone_Number"
                                                placeholder="+1 (phone number)"><span class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Evening_Phone_Number" class="form_field cphone"
                                                id="Evening_Phone_Number" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Name <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Name_"
                                                class="form_field" value="" id="Name_"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Relationship <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Relationship_"
                                                class="form_field" value="" id="Relationship_"
                                                placeholder="Enter relationship here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Day_Phone_Number_" class="form_field cphone"
                                                id="Day_Phone_Number_" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Evening_Phone_Number_" class="form_field cphone"
                                                id="Evening_Phone_Number_" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Name <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Name__"
                                                class="form_field" value="" id="Name__"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Relationship <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Relationship__"
                                                class="form_field" value="" id="Relationship__"
                                                placeholder="Enter relationship here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Day_Phone_Number__" class="form_field cphone"
                                                id="Day_Phone_Number__" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Evening_Phone_Number__" class="form_field cphone"
                                                id="Evening_Phone_Number__" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Name <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Name___"
                                                class="form_field" value="" id="Name___"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Relationship <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Relationship___"
                                                class="form_field" value="" id="Relationship___"
                                                placeholder="Enter relationship here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Day_Phone_Number___" class="form_field cphone"
                                                id="Day_Phone_Number___" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Evening_Phone_Number___" class="form_field cphone"
                                                id="Evening_Phone_Number___" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Name <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="Name____"
                                                class="form_field" value="" id="Name____"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Relationship <span
                                                        class="required_filed"></span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text"
                                                name="Relationship____" class="form_field" value=""
                                                id="Relationship____" placeholder="Enter relationship here"><span
                                                class="animated_class"></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form_box_col2">
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Day_Phone_Number____" class="form_field cphone"
                                                id="Day_Phone_Number____" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="field_holder animated_box">
                                            <div class="phone-trigger"><i class="us flag" data-flag="true"></i><i
                                                    class="fas fa-caret-down"></i></div><input type="text"
                                                name="Evening_Phone_Number____" class="form_field cphone"
                                                id="Evening_Phone_Number____" placeholder="+1 (phone number)"><span
                                                class="animated_class"></span>
                                        </div>
                                    </div>
                                </div>
            ...
            -->
                            ...
                            <div class="form_box">
                                <p><input type="checkbox" name="Docu01" -webkit-appearance: checkbox;> I,<input
                                        type="text" class="cstom_field_desc" name="___Name_"
                                        placeholder="Enter name here" id="___Name_">, authorize Company to verify the
                            ...
                            <div class="form_box">
                                <p><input type="checkbox" name="Docu02" -webkit-appearance: checkbox;> I,<input
                                        type="text" class="cstom_field_desc" name="___Name__"
                                        placeholder="Enter name here" id="___Name__">, agree if employed by Company, to
                            ...
                            <div class="form_box">
                                <p><input type="checkbox" name="Docu03" -webkit-appearance: checkbox;> I,<input
                                        type="text" class="cstom_field_desc" name="___Name___"
                                        placeholder="Enter name here" id="___Name___">, understand that employment with
                            ...
                            <div class="form_box">
                                <p><input type="checkbox" name="Docu04" -webkit-appearance: checkbox;> I,<input
                                        type="text" class="cstom_field_desc" name="___Name____"
                                        placeholder="Enter name here" id="___Name____">, agree that in consideration of
                                    my employment, I agree to conform to the rules and policies of Company. </p>
                            </div>

                            <div class="form_box">
                                <p><input type="checkbox" name="Docu05" -webkit-appearance: checkbox;> I,<input
                                        type="text" class="cstom_field_desc" name="___Name_____"
                                        placeholder="Enter name here" id="___Name_____">, truthfully state that the
                            ...
                            <div class="form_box">
                                <div class="form_box_col2">
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Name <span
                                                        class="required_filed">*</span></strong></label></div>
                                        <div class="field_holder animated_box"><input type="text" name="___Name"
                                                class="form_field" value="" id="sign_name"
                                                placeholder="Enter name here"><span class="animated_class"></span></div>
                                    </div>
                                    <div class="group">
                                        <div class="form_label"><label class="text_uppercase"><strong>Date <span
                                                        class="required_filed"></span></strong></label></div> <input
                                            type="text" class="form_field" id="sign_time"
                                            style="background: #c2c2c2; text-align: center" name="__Date"
                                            value="<?php $date = date("F j, Y"); echo $date; ?>" readonly />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form_box5 secode_box">
                                <div class="group">
                                    <div class="inner_form_box1 recapBtn">
                                        ...
                                        <div class="btn-submit"><input name="submit" type="submit" class="form_button"
                                                value="SUBMIT" /></div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="select-holder" data-ref="">
            ...
            <ul class="country-holder">
                <li class="" data-ccode="ad" data-country="ANDORRA" data-code="+376"><i class="ad flag"></i>ANDORRA
                    (+376)</li>
                <li class="" data-ccode="ae" data-country="UNITED ARAB EMIRATES" data-code="+971"><i
                        class="ae flag"></i>UNITED ARAB EMIRATES (+971)</li>
                <li class="" data-ccode="af" data-country="AFGHANISTAN" data-code="+93"><i
                        class="af flag"></i>AFGHANISTAN (+93)</li>
                <li class="" data-ccode="ag" data-country="ANTIGUA AND BARBUDA" data-code="+1268"><i
                        class="ag flag"></i>ANTIGUA AND BARBUDA (+1268)</li>
                ...
                <li class="" data-ccode="am" data-country="ARMENIA" data-code="+374"><i class="am flag"></i>ARMENIA
                    (+374)</li>
                <li class="" data-ccode="an" data-country="NETHERLANDS ANTILLES" data-code="+599"><i
                        class="an flag"></i>NETHERLANDS ANTILLES (+599)</li>
                ...
                <li class="" data-ccode="ar" data-country="ARGENTINA" data-code="+54"><i class="ar flag"></i>ARGENTINA
                    (+54)</li>
                <li class="" data-ccode="as" data-country="AMERICAN SAMOA" data-code="+1684"><i
                        class="as flag"></i>AMERICAN SAMOA (+1684)</li>
                ...
                <li class="" data-ccode="az" data-country="AZERBAIJAN" data-code="+994"><i
                        class="az flag"></i>AZERBAIJAN (+994)</li>
                <li class="" data-ccode="ba" data-country="BOSNIA AND HERZEGOVINA" data-code="+387"><i
                        class="ba flag"></i>BOSNIA AND HERZEGOVINA (+387)</li>
                <li class="" data-ccode="bb" data-country="BARBADOS" data-code="+1246"><i class="bb flag"></i>BARBADOS
                    (+1246)</li>
                <li class="" data-ccode="bd" data-country="BANGLADESH" data-code="+880"><i
                        class="bd flag"></i>BANGLADESH (+880)</li>
                ...
                <li class="" data-ccode="bl" data-country="SAINT BARTHELEMY" data-code="+590"><i
                        class="bl flag"></i>SAINT BARTHELEMY (+590)</li>
                <li class="" data-ccode="bm" data-country="BERMUDA" data-code="+1441"><i class="bm flag"></i>BERMUDA
                    (+1441)</li>
                <li class="" data-ccode="bn" data-country="BRUNEI DARUSSALAM" data-code="+673"><i
                        class="bn flag"></i>BRUNEI DARUSSALAM (+673)</li>
                ...
                <li class="" data-ccode="cc" data-country="COCOS (KEELING) ISLANDS" data-code="+61"><i
                        class="cc flag"></i>COCOS (KEELING) ISLANDS (+61)</li>
                <li class="" data-ccode="cd" data-country="CONGO,THE DEMOCRATIC REPUBLIC OF THE" data-code="+243"><i
                        class="cd flag"></i>CONGO,THE DEMOCRATIC REPUBLIC OF THE (+243)</li>
                <li class="" data-ccode="cf" data-country="CENTRAL AFRICAN REPUBLIC" data-code="+236"><i
                        class="cf flag"></i>CENTRAL AFRICAN REPUBLIC (+236)</li>
                <li class="" data-ccode="cg" data-country="CONGO" data-code="+242"><i class="cg flag"></i>CONGO (+242)
                </li>
                <li class="" data-ccode="ch" data-country="SWITZERLAND" data-code="+41"><i
                        class="ch flag"></i>SWITZERLAND (+41)</li>
                ...
                <li class="" data-ccode="cv" data-country="CAPE VERDE" data-code="+238"><i class="cv flag"></i>CAPE
                    VERDE (+238)</li>
                <li class="" data-ccode="cx" data-country="CHRISTMAS ISLAND" data-code="+61"><i
                        class="cx flag"></i>CHRISTMAS ISLAND (+61)</li>
                ...
                <li class="" data-ccode="dm" data-country="DOMINICA" data-code="+1767"><i class="dm flag"></i>DOMINICA
                    (+1767)</li>
                <li class="" data-ccode="do" data-country="DOMINICAN REPUBLIC" data-code="+1809"><i
                        class="do flag"></i>DOMINICAN REPUBLIC (+1809)</li>
                ...
                <li class="" data-ccode="fk" data-country="FALKLAND ISLANDS (MALVINAS)" data-code="+500"><i
                        class="fk flag"></i>FALKLAND ISLANDS (MALVINAS) (+500)</li>
                <li class="" data-ccode="fm" data-country="MICRONESIA,FEDERATED STATES OF" data-code="+691"><i
                        class="fm flag"></i>MICRONESIA,FEDERATED STATES OF (+691)</li>
                ...
                <li class="" data-ccode="gq" data-country="EQUATORIAL GUINEA" data-code="+240"><i
                        class="gq flag"></i>EQUATORIAL GUINEA (+240)</li>
                ...
                <li class="" data-ccode="gw" data-country="GUINEA-BISSAU" data-code="+245"><i
                        class="gw flag"></i>GUINEA-BISSAU (+245)</li>
                ...
                <li class="" data-ccode="ir" data-country="IRAN,ISLAMIC REPUBLIC OF" data-code="+98"><i
                        class="ir flag"></i>IRAN,ISLAMIC REPUBLIC OF (+98)</li>
                ...
                <li class="" data-ccode="kg" data-country="KYRGYZSTAN" data-code="+996"><i
                        class="kg flag"></i>KYRGYZSTAN (+996)</li>
                ...
                <li class="" data-ccode="km" data-country="COMOROS" data-code="+269"><i class="km flag"></i>COMOROS
                    (+269)</li>
                <li class="" data-ccode="kn" data-country="SAINT KITTS AND NEVIS" data-code="+1869"><i
                        class="kn flag"></i>SAINT KITTS AND NEVIS (+1869)</li>
                <li class="" data-ccode="kp" data-country="KOREA DEMOCRATIC PEOPLES REPUBLIC OF" data-code="+850"><i
                        class="kp flag"></i>KOREA DEMOCRATIC PEOPLES REPUBLIC OF (+850)</li>
                <li class="" data-ccode="kr" data-country="KOREA REPUBLIC OF" data-code="+82"><i
                        class="kr flag"></i>KOREA REPUBLIC OF (+82)</li>
                <li class="" data-ccode="kw" data-country="KUWAIT" data-code="+965"><i class="kw flag"></i>KUWAIT (+965)
                </li>
                <li class="" data-ccode="ky" data-country="CAYMAN ISLANDS" data-code="+1345"><i
                        class="ky flag"></i>CAYMAN ISLANDS (+1345)</li>
                <li class="" data-ccode="kz" data-country="KAZAKSTAN" data-code="+7"><i class="kz flag"></i>KAZAKSTAN
                    (+7)</li>
                <li class="" data-ccode="la" data-country="LAO PEOPLES DEMOCRATIC REPUBLIC" data-code="+856"><i
                        class="la flag"></i>LAO PEOPLES DEMOCRATIC REPUBLIC (+856)</li>
                ...
                <li class="" data-ccode="lc" data-country="SAINT LUCIA" data-code="+1758"><i class="lc flag"></i>SAINT
                    LUCIA (+1758)</li>
                <li class="" data-ccode="li" data-country="LIECHTENSTEIN" data-code="+423"><i
                        class="li flag"></i>LIECHTENSTEIN (+423)</li>
                ...
                <li class="" data-ccode="lt" data-country="LITHUANIA" data-code="+370"><i class="lt flag"></i>LITHUANIA
                    (+370)</li>
                <li class="" data-ccode="lu" data-country="LUXEMBOURG" data-code="+352"><i
                        class="lu flag"></i>LUXEMBOURG (+352)</li>
                <li class="" data-ccode="lv" data-country="LATVIA" data-code="+371"><i class="lv flag"></i>LATVIA (+371)
                </li>
                <li class="" data-ccode="ly" data-country="LIBYAN ARAB JAMAHIRIYA" data-code="+218"><i
                        class="ly flag"></i>LIBYAN ARAB JAMAHIRIYA (+218)</li>
                ...
                <li class="" data-ccode="md" data-country="MOLDOVA,REPUBLIC OF" data-code="+373"><i
                        class="md flag"></i>MOLDOVA,REPUBLIC OF (+373)</li>
                <li class="" data-ccode="me" data-country="MONTENEGRO" data-code="+382"><i
                        class="me flag"></i>MONTENEGRO (+382)</li>
                <li class="" data-ccode="mf" data-country="SAINT MARTIN" data-code="+1599"><i class="mf flag"></i>SAINT
                    MARTIN (+1599)</li>
                <li class="" data-ccode="mg" data-country="MADAGASCAR" data-code="+261"><i
                        class="mg flag"></i>MADAGASCAR (+261)</li>
                <li class="" data-ccode="mh" data-country="MARSHALL ISLANDS" data-code="+692"><i
                        class="mh flag"></i>MARSHALL ISLANDS (+692)</li>
                ...
                <li class="" data-ccode="mp" data-country="NORTHERN MARIANA ISLANDS" data-code="+1670"><i
                        class="mp flag"></i>NORTHERN MARIANA ISLANDS (+1670)</li>
                <li class="" data-ccode="mr" data-country="MAURITANIA" data-code="+222"><i
                        class="mr flag"></i>MAURITANIA (+222)</li>
                <li class="" data-ccode="ms" data-country="MONTSERRAT" data-code="+1664"><i
                        class="ms flag"></i>MONTSERRAT (+1664)</li>
                ...
                <li class="" data-ccode="my" data-country="MALAYSIA" data-code="+60"><i class="my flag"></i>MALAYSIA
                    (+60)</li>
                <li class="" data-ccode="mz" data-country="MOZAMBIQUE" data-code="+258"><i
                        class="mz flag"></i>MOZAMBIQUE (+258)</li>
                ...
                <li class="" data-ccode="ni" data-country="NICARAGUA" data-code="+505"><i class="ni flag"></i>NICARAGUA
                    (+505)</li>
                <li class="" data-ccode="nl" data-country="NETHERLANDS" data-code="+31"><i
                        class="nl flag"></i>NETHERLANDS (+31)</li>
                ...
                <li class="" data-ccode="pf" data-country="FRENCH POLYNESIA" data-code="+689"><i
                        class="pf flag"></i>FRENCH POLYNESIA (+689)</li>
                <li class="" data-ccode="pg" data-country="PAPUA NEW GUINEA" data-code="+675"><i
                        class="pg flag"></i>PAPUA NEW GUINEA (+675)</li>
                <li class="" data-ccode="ph" data-country="PHILIPPINES" data-code="+63"><i
                        class="ph flag"></i>PHILIPPINES (+63)</li>
                ...
                <li class="" data-ccode="pm" data-country="SAINT PIERRE AND MIQUELON" data-code="+508"><i
                        class="pm flag"></i>SAINT PIERRE AND MIQUELON (+508)</li>
                ...
                <li class="" data-ccode="ru" data-country="RUSSIAN FEDERATION" data-code="+7"><i
                        class="ru flag"></i>RUSSIAN FEDERATION (+7)</li>
                ...
                <li class="" data-ccode="sa" data-country="SAUDI ARABIA" data-code="+966"><i class="sa flag"></i>SAUDI
                    ARABIA (+966)</li>
                <li class="" data-ccode="sb" data-country="SOLOMON ISLANDS" data-code="+677"><i
                        class="sb flag"></i>SOLOMON ISLANDS (+677)</li>
                <li class="" data-ccode="sc" data-country="SEYCHELLES" data-code="+248"><i
                        class="sc flag"></i>SEYCHELLES (+248)</li>
                ...
                <li class="" data-ccode="sr" data-country="SURINAME" data-code="+597"><i class="sr flag"></i>SURINAME
                    (+597)</li>
                <li class="" data-ccode="st" data-country="SAO TOME AND PRINCIPE" data-code="+239"><i
                        class="st flag"></i>SAO TOME AND PRINCIPE (+239)</li>
                <li class="" data-ccode="sv" data-country="EL SALVADOR" data-code="+503"><i class="sv flag"></i>EL
                    SALVADOR (+503)</li>
                <li class="" data-ccode="sy" data-country="SYRIAN ARAB REPUBLIC" data-code="+963"><i
                        class="sy flag"></i>SYRIAN ARAB REPUBLIC (+963)</li>
                <li class="" data-ccode="sz" data-country="SWAZILAND" data-code="+268"><i class="sz flag"></i>SWAZILAND
                    (+268)</li>
                <li class="" data-ccode="tc" data-country="TURKS AND CAICOS ISLANDS" data-code="+1649"><i
                        class="tc flag"></i>TURKS AND CAICOS ISLANDS (+1649)</li>
                ...
                <li class="" data-ccode="th" data-country="THAILAND" data-code="+66"><i class="th flag"></i>THAILAND
                    (+66)</li>
                <li class="" data-ccode="tj" data-country="TAJIKISTAN" data-code="+992"><i
                        class="tj flag"></i>TAJIKISTAN (+992)</li>
                <li class="" data-ccode="tk" data-country="TOKELAU" data-code="+690"><i class="tk flag"></i>TOKELAU
                    (+690)</li>
                <li class="" data-ccode="tl" data-country="TIMOR-LESTE" data-code="+670"><i
                        class="tl flag"></i>TIMOR-LESTE (+670)</li>
                <li class="" data-ccode="tm" data-country="TURKMENISTAN" data-code="+993"><i
                        class="tm flag"></i>TURKMENISTAN (+993)</li>
                ...
                <li class="" data-ccode="tt" data-country="TRINIDAD AND TOBAGO" data-code="+1868"><i
                        class="tt flag"></i>TRINIDAD AND TOBAGO (+1868)</li>
                <li class="" data-ccode="tv" data-country="TUVALU" data-code="+688"><i class="tv flag"></i>TUVALU (+688)
                </li>
                <li class="" data-ccode="tw" data-country="TAIWAN,PROVINCE OF CHINA" data-code="+886"><i
                        class="tw flag"></i>TAIWAN,PROVINCE OF CHINA (+886)</li>
                <li class="" data-ccode="tz" data-country="TANZANIA,UNITED REPUBLIC OF" data-code="+255"><i
                        class="tz flag"></i>TANZANIA,UNITED REPUBLIC OF (+255)</li>
                ...
                <li class="" data-ccode="uy" data-country="URUGUAY" data-code="+598"><i class="uy flag"></i>URUGUAY
                    (+598)</li>
                <li class="" data-ccode="uz" data-country="UZBEKISTAN" data-code="+998"><i
                        class="uz flag"></i>UZBEKISTAN (+998)</li>
                <li class="" data-ccode="va" data-country="HOLY SEE (VATICAN CITY STATE)" data-code="+39"><i
                        class="va flag"></i>HOLY SEE (VATICAN CITY STATE) (+39)</li>
                <li class="" data-ccode="vc" data-country="SAINT VINCENT AND THE GRENADINES" data-code="+1784"><i
                        class="vc flag"></i>SAINT VINCENT AND THE GRENADINES (+1784)</li>
                <li class="" data-ccode="ve" data-country="VENEZUELA" data-code="+58"><i class="ve flag"></i>VENEZUELA
                    (+58)</li>
                <li class="" data-ccode="vg" data-country="VIRGIN ISLANDS,BRITISH" data-code="+1284"><i
                        class="vg flag"></i>VIRGIN ISLANDS,BRITISH (+1284)</li>
                <li class="" data-ccode="vi" data-country="VIRGIN ISLANDS,U.S." data-code="+1340"><i
                        class="vi flag"></i>VIRGIN ISLANDS,U.S. (+1340)</li>
                ...
                <li class="" data-ccode="vu" data-country="VANUATU" data-code="+678"><i class="vu flag"></i>VANUATU
                    (+678)</li>
                <li class="" data-ccode="wf" data-country="WALLIS AND FUTUNA" data-code="+681"><i
                        class="wf flag"></i>WALLIS AND FUTUNA (+681)</li>
                ...
                <div class="col-12">
                    <div class="box-list-footer">
                        ...
                        <div class="box-list box-useful">
                            ...
                            <ul class="one-half first">
                                <li><a href="about-us.html" title=""><span><i class="fa fa-square"></i></span>About
                                        Us</a></li>
                                <li><a href="doctor.html" title=""><span><i class="fa fa-square"></i></span>Team</a>
                                </li>
                                <!-- <li><a href="about-us.html" title=""><span><i class="fa fa-square"></i></span>Testomonial</a></li> -->
                                <li><a href="services.html" title=""><span><i
                                                class="fa fa-square"></i></span>Services</a></li>
                            </ul><!-- /.one-half -->
                        </div><!-- /.widget-services -->
                            ...
                            <div class="container foot-container">
                                <div class="row footer-row">
                                    ...
                                    <ul class="list-icon-bottom">
                                        <li class="bottom-icon-active  "><a href="#" title=""><i
                                                    class="fab fa-facebook-f"></i></a></li>
                                        <li class="bottom-icon-style "><a href="#" title=""><i
